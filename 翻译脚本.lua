...
if player.PlayerGui:FindFirstChild("BoxiuUI")then player.PlayerGui.BoxiuUI:Destroy()end
...
UserInputService.InputBegan:Connect(function(i)
    if i.KeyCode==Enum.KeyCode.F9 then mainFrame.Visible=not mainFrame.Visible end
end)
